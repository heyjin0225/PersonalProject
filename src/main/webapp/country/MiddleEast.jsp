		...
		<div class="container">
			...
			<div id="serachOptionList" align="right" style="width: 71.2%; margin-bottom: 9px; margin-left: 14%;">
				<select id="searchOption" class="searchOption-control">
					<option value="countryid2">나라</option>
					<option value="cityid">도시</option>
				</select>
...
<div id="MiddleEast-list" align="center" style ="margin: 0 auto; width : 80%;"></div>
<div class="nextviewDiv" align="center" style="width: 72%; margin-left: 11.5%; float: left"></div>

<script type="text/javascript" src="http://code.jquery.com/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="../country/js/MiddleEast.js"></script>