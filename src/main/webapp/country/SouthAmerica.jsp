	...
	<section id="SouthAmerica">
		<div class="container">
			<div class="section-header" style="text-align: center;">
				<h2 style="font-size: 20pt;">남아메리카</h2>
			</div>
...
<div id="SouthAmerica-list" align="center" style ="margin: 0 auto; width : 80%;"></div>
<div class="nextviewDiv" align="center" style="width: 72%; margin-left: 11.5%; float: left"></div>

<script type="text/javascript" src="http://code.jquery.com/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="../country/js/SouthAmerica.js"></script>
